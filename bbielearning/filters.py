...
class UserFilter(django_filters.FilterSet):
    username = django_filters.CharFilter(lookup_expr='icontains',label="Student ID")
...
class UserSuspendFilter(django_filters.FilterSet):
    ...
    #     super(UserPriorityFilter, self).__init__(*args, **kwargs)
    #     self.filters['username']= self.filters['username'].split()
